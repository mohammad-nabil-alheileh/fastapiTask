...
set -gx VIRTUAL_ENV /home/moahammad-nabil/Desktop/python/fast_task/library_app/.venv
...
if test -n library-app-py3.13
    set -gx VIRTUAL_ENV_PROMPT library-app-py3.13
else
